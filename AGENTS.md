...
This project is indexed by GitNexus as **full_noon_saloon** (3563 symbols, 7545 relationships, 275 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
