...
This project is indexed by GitNexus as **full_noon_saloon** (2655 symbols, 6382 relationships, 211 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
